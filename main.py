...
if __name__ == '__main__':
    ...
    # parser.add_argument('--save_path', type=str, default='./model_ablation_res3.pt')
    ...
    model = Model(config)
    # model.load_state_dict(torch.load('model_res_biaffine_cdtier.pt'))
    # print("loaded model")
    ...
    trainer.predict("Final", test_loader, ori_data[-2])
